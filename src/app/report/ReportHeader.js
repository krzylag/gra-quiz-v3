        ...
        return (
            <div className="ReportHeader">
                ...
                <div className="rh rh-middle">
                    <Button size="sm" variant="outline-secondary" onClick={this.onClickF} disabled={this.props.isRefreshDisabled}>{this.getRefreshSvg()}</Button>
                </div>
